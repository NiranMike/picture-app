    ...
    return (
        <div className="">
            ...
            <button onClick={submitSearch}
                className=" absolute search-btn z-10 top-[380px] md:top-[300px] left-[115px] md:left-[500px] lg:left-[550px] mm:left-[155px] xl:left-[800px] 2xl:left-[1500px] bg-white py-2 px-3 mr-9 md:border-white border md:hover:bg-blue-500 font-bold md:hover:text-white rounded-md">Submit</button>
